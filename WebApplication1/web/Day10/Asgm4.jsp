        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=4" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input string (s): </label>
                        <input name="str" type="text" class="form-control" id="inputA" placeholder="Ex: leetcode">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input words in dictionary (spaced-separate): </label>
                        <input name="words" type="text" class="form-control" id="inputA" placeholder="Ex: leet code le co">
                    </div>
