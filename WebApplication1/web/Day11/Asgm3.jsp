        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=3" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input elements of doubly linked list: </label>
                        <input name="nums" type="text" class="form-control" id="inputA" placeholder="Ex: 1 2 4">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input element you want to insert: </label>
                        <input name="n" type="text" class="form-control" id="inputA" placeholder="Ex: 3">
                    </div>
