...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day5/A2.1.png" alt="alt"/>
                <img src="images/Day5/A2.2.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay5?asgm=2" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input numbers: </label>
                        <input name="a" type="text" class="form-control" id="inputA" placeholder=" contains n space-separated integers. Ex: 1000000001 1000000002 1000000003 1000000004 1000000005">
                    </div>
