    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=2_1&size=${size}" method="post">
                    <c:forEach begin="0" end="${size-1}" var="row">
                        <div class="mb-3">
                            <label for="inputA${row}" class="form-label">Input information name and number of people ${row + 1}: </label>
                            <input style="margin-bottom: 5px" name="name${row}" type="text" class="form-control" id="inputA${row}" placeholder="Name Ex: uncle sam">
                            <input name="num${row}" type="text" class="form-control" id="inputN${row}" placeholder="Number Ex: 99912222">
                        </div>
                    </c:forEach>
