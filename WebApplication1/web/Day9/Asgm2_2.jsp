    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=2_2" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input name you want to search number phone in the phone book: </label>
                        <input name="name" type="text" class="form-control" id="inputA" placeholder="Ex: uncle sam">
                    </div>
