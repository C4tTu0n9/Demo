        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=5" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input string 1: </label><br>
                        <input name="n1" type="text" class="form-control" id="inputA" placeholder="Ex: HARRY">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input string 2: </label>
                        <input name="n2" type="text" class="form-control" id="inputA" placeholder="Ex: SALLY">
                    </div>
