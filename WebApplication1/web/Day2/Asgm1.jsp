...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day2/A1.1.png" alt="alt"/>
                <img src="images/Day2/A1.2.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay2?asgm=1" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input R (Row):</label>
                        <input name="r" type="text" class="form-control" id="inputA" placeholder="Input integers in rth row. Ex: 6">
                    </div>
                    <div class="mb-3">
                        <label for="inputB" class="form-label">Input C (Column):</label>
                        <input name="c" type="text" class="form-control" id="inputA" placeholder="Input integers in cth column. Ex: 3">
                    </div>
