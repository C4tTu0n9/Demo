...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day3/A4.1.png" alt="alt"/>
                <img src="images/Day3/A4.2.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay3?asgm=4" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input String: </label>
                        <input name="str" type="text" class="form-control" id="inputA" placeholder="Input string. Ex: Helloworld">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input start number: </label>
                        <input name="num1" type="text" class="form-control" id="inputA" placeholder="Input number. Ex: 3">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input end number: </label>
                        <input name="num2" type="text" class="form-control" id="inputA" placeholder="Input number. Ex: 7">
                    </div>
