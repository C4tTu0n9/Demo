    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay2?asgm=2" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input number of attendees: </label>
                        <input name="num" type="text" class="form-control" id="inputA" placeholder="The number of attendees. Ex: 3">
                    </div>
