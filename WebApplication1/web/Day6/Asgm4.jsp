           ...
           <div class="left-pane">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=4" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input elements in linked list: </label>
                        <input name="n1" type="text" class="form-control" id="inputA" placeholder="Input numbers. Ex: 1 2 3 1">
                    </div>
