...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day1/A3.1.png" alt="alt"/>
                <img src="images/Day1/A3.2.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay1?asgm=3" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input number: </label>
                        <input name="num" type="text" class="form-control" id="inputA" placeholder="Input number. Ex: 148">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input number of repetitions: </label>
                        <input name="rep" type="text" class="form-control" id="inputA" placeholder="Input number. Ex: 3">
                    </div>
