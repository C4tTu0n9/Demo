...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day1/A5.1.png" alt="alt"/>
                <img src="images/Day1/A5.2.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay1?asgm=5" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input String: </label>
                        <input name="num" type="text" class="form-control" id="inputA" placeholder="Input string. Ex: RGGR">
                    </div>
