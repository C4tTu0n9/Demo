            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=2" method="post">
                    <div class="mb-3">
                        ...
                        <input name="str" type="text" class="form-control" id="inputA" placeholder="Ex: middle-Outz">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input the number of letters to rotate the alphabet by: </label>
                        <input name="num" type="text" class="form-control" id="inputA" placeholder="Ex: 2">
                    </div>
