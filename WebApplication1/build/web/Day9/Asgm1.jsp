...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <div hidden="">${i=9}</div>
                <img src="images/Day${i}/A1.1.png" alt="alt"/>
                <img src="images/Day${i}/A1.2.png" alt="alt"/>
                <img src="images/Day${i}/A1.3.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=1" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input elements in array: </label>
                        <input name="nums" type="text" class="form-control" id="inputA" placeholder="Ex: 41 77 74 22 44">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input the index you want to query in array: </label>
                        <input name="query" type="text" class="form-control" id="inputA" placeholder="Ex: 1">
                    </div>
