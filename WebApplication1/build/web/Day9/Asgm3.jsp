        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=3" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input string name: </label>
                        <input name="n" type="text" class="form-control" id="inputA" placeholder="Ex: john tom">
                    </div>
                    <button type="submit" class="btn btn-primary">Run test case</button>
                </form>

                <div class="mt-4">
                    <h5>Number of name in the set:</h5>
