        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=2" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input number of entries in the phone book: </label>
                        <input name="size" type="text" class="form-control" id="inputA" placeholder="Ex: 3">
                    </div>
