...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day4/A4.1.png" alt="alt"/>
                <img src="images/Day4/A4.2.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay4?asgm=4" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input n: </label>
                        <input name="n" type="text" class="form-control" id="inputA" placeholder="Input number. Ex: 6">
                    </div>
