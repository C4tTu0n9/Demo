...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day4/A2.1.png" alt="alt"/>
                <img src="images/Day4/A2.2.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay4?asgm=2" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input numbers of array: </label>
                        <input name="a" type="text" class="form-control" id="inputA" placeholder=" contains n space-separated integers. Ex: 1 2 3 4 10 11">
                    </div>
