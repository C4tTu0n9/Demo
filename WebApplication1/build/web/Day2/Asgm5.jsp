...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day2/A5.1.png" alt="alt"/>
                <img src="images/Day2/A5.2.png" alt="alt"/>
                <img src="images/Day2/A5.2.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay2?asgm=5" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input numbers: </label>
                        <input name="nums" type="text" class="form-control" id="inputA" placeholder="Contains n space-separated integers. Ex: 1 2 1 1 1 2 1 3">
                    </div>
