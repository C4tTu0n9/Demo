...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day13/A5.1.png" alt="alt"/>
                <img src="images/Day13/A5.2.png" alt="alt"/>
                <img src="images/Day13/A5.3.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay13?asgm=5" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Nodes: </label>
                        <input name="nodes" type="text" class="form-control" id="inputA" placeholder="Input integers separated by spaces. Ex:1 3 2">
                    </div>
