    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=4_1&size=${size}" method="post">
                    <h3>Size of Matrix: ${size}</h3>
                    <c:forEach begin="0" end="${size-1}" var="row">
                        <div class="mb-3">
                            <label for="inputA${row}" class="form-label">Input number consists of space-separated integers for row ${row + 1}: </label>
                            <input name="n${row}" type="text" class="form-control" id="inputA${row}" placeholder="If size = 3, Ex: 1 2 3">
                        </div>
                    </c:forEach>
