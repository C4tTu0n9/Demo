        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=3" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input numbers in array: </label>
                        <input name="n" type="text" class="form-control" id="inputA" placeholder="Contains n space-separated integers. Ex: 3 2 1 3">
                    </div>
