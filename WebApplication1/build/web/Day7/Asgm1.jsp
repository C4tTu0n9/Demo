            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=1" method="post">
                    <div class="mb-3">
                        ...
                        <input name="num1" type="text" class="form-control" id="inputA" placeholder="Input numbers. Ex: 1 2 3 4 5">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input the amount to rotate by: </label>
                        <input name="num2" type="text" class="form-control" id="inputA" placeholder="Input numbers. Ex: 3">
                    </div>
