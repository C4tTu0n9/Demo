...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day5/A4.1.png" alt="alt"/>
                <img src="images/Day5/A4.2.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay5?asgm=4" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input number 1: </label>
                        <input name="n1" type="text" class="form-control" id="inputA" placeholder="Input number. Ex: 3">
                    </div>
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input number 2: </label>
                        <input name="n2" type="text" class="form-control" id="inputA" placeholder="Input number. Ex: 898">
                    </div>
