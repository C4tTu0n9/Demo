...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day3/A5.1.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay3?asgm=5" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input string: </label>
                        <input name="str" type="text" class="form-control" id="inputA" placeholder="Ex: madam">
                    </div>
