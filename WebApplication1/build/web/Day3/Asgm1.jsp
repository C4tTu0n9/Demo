...
<html lang="vi">
    ...
    <body>
        ...
        <div class="split resizable">
            ...
            <div class="left-pane">
                <img src="images/Day3/A1.1.png" alt="alt"/>
                <img src="images/Day3/A1.2.png" alt="alt"/>
                <img src="images/Day3/A1.3.png" alt="alt"/>
            </div>
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay3?asgm=1" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input number:</label>
                        <input name="num" type="text" class="form-control" id="inputA" placeholder="Input integers. Ex: 3">
                    </div>
