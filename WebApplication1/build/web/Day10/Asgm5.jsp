        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=5" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input words (spaced-separate): </label>
                        <input name="words" type="text" class="form-control" id="inputA" placeholder="Ex: a banana app ap appl apple apply">
                    </div>
