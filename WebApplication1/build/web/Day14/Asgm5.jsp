        ...
        <div class="split resizable">
            ...
            <div class="right-pane">
                ...
                <form action="SolutionDay${i}?asgm=5" method="post">
                    <div class="mb-3">
                        <label for="inputA" class="form-label">Input numbers of array (spaced-separate): </label>
                        <input name="nums" type="text" class="form-control" id="inputA" placeholder="Ex: 7 1 5 3 6 4">
                    </div>
